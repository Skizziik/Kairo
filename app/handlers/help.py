...
TEXT = (
    ...
    "/top — топ активных.\n\n"
    "<b>Казино и кейсы 🎰:</b>\n"
    "/casino — открыть полноценное Mini App\n"
    "/balance — твой баланс коинов\n"
    "/daily — забрать ежедневные коины (растёт стрик)\n"
    "/inv_text — инвентарь в тексте (для Mini App используй /casino)\n"
    "/top_rich — лидерборд по коинам\n\n"
    "<b>Игрушки:</b>\n"
