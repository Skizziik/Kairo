...
COIN_DROP_RATIO = 0.22        # was 0.16 — kills feel rewarding
BOSS_COIN_MULT = 12           # was 5 — bosses are clearly worth fighting
...
RES_COST_GROWTH = 1.12        # resource costs scale per level (steeper so high-lvl bites)
